...
public final class LunarCalendar {
     ...
     */
    public static void setupLunarCalendar(CalendarDay calendar) {
        ...
        CalendarDay lunarCalendar = CalendarDay.obtain();
        ...
        calendar.setSpecialFestival(specialFestival);
     ...
     * @return 获取农历节日
     */
    public static String getLunarText(CalendarDay calendar) {
