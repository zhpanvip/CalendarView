...
public final class WeekViewPager extends ViewPager {
     ...
     * @return 获取当前周数据
     */
    List<CalendarDay> getCurrentWeekCalendars() {
        List<CalendarDay> calendars = CalendarUtil.getWeekCalendars(mDelegate.mIndexCalendar,
                mDelegate);
     ...
     * 更新任意一个选择的日期
     */
    void updateSelected(CalendarDay calendar, boolean smoothScroll) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        heightMeasureSpec = MeasureSpec.makeMeasureSpec(mDelegate.getCalendarItemHeight() + mDelegate.getCalendarPaddingTop(), MeasureSpec.EXACTLY);
    ...
    private class WeekViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            try {
                ...
                return new CalendarWeekView(getContext());
            }
