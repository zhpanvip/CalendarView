...
public abstract class BaseWeekView extends BaseMontWeekView {
     ...
     */
    final void setup(CalendarDay calendar) {
     ...
     */
    final void performClickCalendar(CalendarDay calendar, boolean isNotice) {
        ...
        CalendarDay currentCalendar = mItems.get(week);
     ...
     * @return 是否是最小访问边界了
     */
    final boolean isMinRangeEdge(CalendarDay calendar) {
    ...
    final void updateWeekStart() {
        ...
        CalendarDay calendar = CalendarUtil.getFirstCalendarStartWithMinCalendar(mDelegate.getMinYear(),
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        heightMeasureSpec = MeasureSpec.makeMeasureSpec(getItemHeight() + mDelegate.getCalendarPaddingTop(), MeasureSpec.EXACTLY);
